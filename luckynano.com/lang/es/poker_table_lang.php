...
$poker_table_lang = array(
  ...
  'tournament_date' => 'Hora de inicio',
  ...
  'Tasa de la mesa: <span id="fee_info_amount">0</span>el % de las ganancias cuando dejas una mesa <a href="../old/faq.php#poker_fee" target="blank"><i class="mdi mdi-help-circle"></i></a><br>
    (no hay tasas para las ganancias menores a <img class="nano_logo" src="images/assets/nano.png"/> 0.005) </div>',
  ...
  'increase_info_1' => 'el Ante se duplica cada ',
  'increase_info_2' => ' segundos',

  'message_sitout' => 
  'En la próxima ronda saldrás de la mesa<br>
  ...
  'Finalizaste en la posición <span id="game_over_rank"></span> and won <img class="nano_logo" src="images/assets/nano.png"/> <span id="game_over_win"></span>.',
